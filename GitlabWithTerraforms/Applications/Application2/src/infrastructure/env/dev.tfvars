resource_group_name = "RG-eMobility-Operator-Integration-Dev"
workspace_name      = "Log-eMobility-Operator-Dev"

key_vault_name = "KV-eMob-Operator-Dev"
key_vault_roles = [
  {
    name                 = "Reader"
...
storage_account_name = "stadfoperatordev"
storage_roles = [
  {
    name                 = "Testers"
...
data_factory_name = "ADF-Operator-Dev"

cosmosdb_account_name = "cosmon-operators-dev"

cluster_name = "cospos-emobility-operators-dev"
